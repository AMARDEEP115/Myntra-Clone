...
function WomenSingle() {
  ...
  const getData = async () => {
    let res = await fetch(`https://scary-fly-gilet.cyclic.app/women/${id}`);
  ...
  const addToData = (data) => {
    axios
      .post("https://scary-fly-gilet.cyclic.app/cart", data)
              ...
              <SubDetailsDiv>
                <div style={{ width: "95%", margin: "auto" }}>
                  ...
                  >
                    ...
                    <WishDiv onClick={() => {dispatch(addToDataWishlist(ele))}}>
